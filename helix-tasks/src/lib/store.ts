...
import type { Task, View, Filters, AppMode, NoteInfo } from './types';

export const folderPath = writable<string>('');
export const appMode = writable<AppMode>('tasks');
...
export const selectedNote = writable<NoteInfo | null>(null);
